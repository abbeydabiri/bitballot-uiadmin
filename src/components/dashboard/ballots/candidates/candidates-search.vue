			...
			<table-display searchBy="candidate name">
				...
				<template slot="tableBody" v-if="recordList.length > 0">
					<tr class="stripe-dark" v-for="(candidate, index) in recordList" :key="index">
						...
						<td class=" pa2"> 
							<span class="f7">#{{index+1}} -</span> {{candidate.Code}}
						</td>
						<td class=" pa2 f7">{{candidate.Title}}</td>
						<td class=" pa2 f7">{{candidate.Owner}}</td>
						<td class=" pa2 f7">{{candidate.Partner}}</td>
						<td class=" pa2 f7">{{candidate.Workflow}}</td>
						<td class=" pa2 f7">{{candidate.Updatedate}}</td>
					</tr>
				</template>
			</table-display>
