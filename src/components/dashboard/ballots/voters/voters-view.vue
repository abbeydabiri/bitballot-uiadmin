        ...
        <div v-if="isFound" class="pa2 bg-light-gray br4 cf w-100">
			...
			<div class="w-100">
				<div class="fl pa2 mt3 mt0-ns w-100 w-third-ns">
					...
					<input class="pa2 ba b--silver br2 bg-white w-100 " type="text" disabled="disabled" v-model="record.Voter">
				</div>
            ...
            <div class="fl w-100 mt3">
                <router-link :to="{name:'voters-edit',params:{id:record.ID}}" class="fr ph3 pv2 br4 bg-green grow-ns pointer f6 white tc no-underline" >
                    Edit
                </router-link>
            </div>
