      ...
      <div class="pa2 bg-light-gray br4 cf">
        ...
        <div class="fl w-80-l w-75-m w-100 pa2 pl4-l">
          <form action="sign-up_submit" method="get" accept-charset="utf-8"  >
              ...
              <div class="w-100">
                <div class="mt3 w-20">
                  <label class="db fw4 lh-copy f6 black">Is Admin</label>
                  <input class="pa2 ba b--silver br2 bg-white w-100 " type="checkbox" v-model="record.IsAdmin">
                </div>
              </div>
